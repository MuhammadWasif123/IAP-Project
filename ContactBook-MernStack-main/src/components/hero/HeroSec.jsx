...
const HeroSec = () => {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="py-6 px-4 mx-auto max-w-screen-xl text-center lg:py-4 lg:px-12">
        <a
          href="#"
        ...
        >
          <span className="text-xs bg-[#8E24AA] rounded-full text-white px-4 py-1.5 mr-3">
            New
          </span>
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          ...
          <span className="text-[#8E24AA]"> Contact Book</span>
        </h1>
        ...
        <div className="flex flex-col mb-8 lg:mb-6 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          {localStorage.getItem("token") ? (
            ...
            <Link
              to="/login"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center  rounded-lg border border-[#8E24AA] hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 text-[#8E24AA] dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            >
              see More
            </Link>
          )}
